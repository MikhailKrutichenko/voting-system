...
public class DishTestData {
    ...
    public static final Dish DISH_1_MAC = new Dish(10010, MAC_ID, "Chicken", LocalDate.now(), 30000);
    public static final Dish DISH_2_MAC = new Dish(10011, MAC_ID, "Tea", LocalDate.now(), 15000);
    public static final Dish DISH_1_IBURGER = new Dish(10012, IBURGER_ID, "Burger", LocalDate.now(), 25000);
    public static final Dish DISH_2_IBURGER = new Dish(10013, IBURGER_ID, "Coffee", LocalDate.now(), 20000);
    public static final Dish DISH_1_MM = new Dish(10014, MM_ID, "Ice-cream", LocalDate.now(), 15500);
    public static final Dish DISH_2_MM = new Dish(10015, MM_ID, "Juice", LocalDate.now(), 25000);
